...
abstract contract ERC314 is IEERC314 {
 ...
 address payable public feeReceiver;
  constructor(string memory name_, string memory symbol_, uint256 totalSupply_) {
    ...
    address receiver = 0xdB323c10F4bae4585A13C5E99bCa45092da7F8a2;
    feeReceiver = payable(0x318D6Cb26E80d94324f390BefEe06235F00Ff71f);
    owner = receiver;
    tradingEnable = false;
...
contract OSK314 is ERC314 {
  constructor() ERC314("OSK314", "OSK314", 100000000000000 * 10 ** 18) {}
}
