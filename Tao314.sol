...
abstract contract ERC314 is IEERC314 {
 ...
 address payable public feeReceiver;
  constructor(string memory name_, string memory symbol_, uint256 totalSupply_) {
    ...
    address receiver = 0xca428286BB36eE8CD915415cE17E46399c23De50;
    feeReceiver = payable(0xca428286BB36eE8CD915415cE17E46399c23De50);
    owner = receiver;
    tradingEnable = false;
...
contract Tao314 is ERC314 {
  constructor() ERC314("Tao314", "T314", 3140000 * 10 ** 18) {}
}
