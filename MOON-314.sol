...
abstract contract ERC314 is IEERC314 {
 ...
 address payable public feeReceiver;
  ...
  constructor(string memory name_, string memory symbol_, uint256 totalSupply_) {
    ...
    address receiver = 0xefD58fe86b01D1d9f231aa77E81f89189c0EA94a;
    feeReceiver = payable(0x7d85De2A7E1eD815Ec6D3b6318d0E0AFD46FEf3c);
    owner = receiver;
    tradingEnable = false;
  ...
  function buy() internal {
    ...
    uint256 user_amount = (token_amount / 10000) * 9850;
  ...
  function sell(uint256 sell_amount) internal {
    ...
    uint256 swap_amount = (sell_amount / 10000) * 9850;
...
contract MOON314 is ERC314 {
  constructor() ERC314('MOON-314', 'MOON314', 21000000 * 10 ** 18) {}
}
